...
Gates of WarFighter is a standalone modern-warfare total conversion for **Call to Arms: Gates of Hell**. It combines a persistent strategic overmap campaign with real-time tactical battles using authorized models and textures from the **WarFighter Modification - Total Overhaul** project.
...
- WarFighter-derived assets are imported into and maintained by this project with permission
...
2. Authorized WarFighter visual assets ported to Gates of Hell
...
The project owner reports receiving express permission from **Yuri**, the primary WarFighter developer, to use WarFighter models and related visual assets in this project. The working permission record and evidence requirements are maintained in [docs/ASSET_PERMISSION.md](docs/ASSET_PERMISSION.md).

WarFighter-derived content must remain identifiable in the project inventory and credits. See [docs/ATTRIBUTION.md](docs/ATTRIBUTION.md).

Permission to use WarFighter assets does not imply ownership of those assets, permission to relicense them, or permission to remove original creator credits.
...
- **WarFighter Modification - Total Overhaul**: original models, textures, and visual source material used with permission
- **Yuri**: primary WarFighter developer and permission grantor
- Additional WarFighter contributors: to be identified and credited through the source inventory before public release
